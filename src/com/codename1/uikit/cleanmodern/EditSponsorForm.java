 ...
 * @author hazem
 */
public class EditSponsorForm extends BaseForm{
    public EditSponsorForm(Resources res, Sponsor ev) {
        ...
        submit.addActionListener(l -> {
            if (nom.getText().isEmpty() || type.getText().isEmpty()) {
                ...
                if (ServiceSponsor.getInstance().editSponsor(ev)) {
                    Dialog.show("Success", "Sponsor Edited", new Command("OK"));
