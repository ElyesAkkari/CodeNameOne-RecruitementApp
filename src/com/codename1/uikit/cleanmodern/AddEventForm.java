...
public class AddEventForm extends BaseForm{
    public AddEventForm(Resources res) {
        ...
        addEvent.addActionListener(l -> {
            if (nom.getText().isEmpty() || type.getText().isEmpty()|| description.getText().isEmpty()|| image.getText().isEmpty()) {
                ToastBar.showMessage("Fill all Text Areas", FontImage.MATERIAL_ERROR);
                //Dialog.show("Fill all Text Areas", "", "annuler","ok");
            } else {
                SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd");
                Event e = new Event(nom.getText(), type.getText(),20.0f,description.getText(),
                datePicker.getDate(),image.getText());
