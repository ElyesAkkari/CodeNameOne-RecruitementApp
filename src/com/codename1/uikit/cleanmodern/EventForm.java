...
public class EventForm extends BaseForm{
    ...
    public EventForm(Resources res) {
        ...
        Button addRec = new Button("request about an event");
        addEvent.addActionListener(l -> {
...
//        //!---
        ...
        participer.addActionListener(l->{
            if (Dialog.show("Confirmation", "Participate \" " + e.getNom() + "\" ?", "ok", "cancel")) {

                    if (ServiceEvent.getInstance().addParticipation(p)) {
                        Dialog.show("Success", "Participation succeeded", new Command("OK"));
        ...
        cnt.addPointerPressedListener(l -> {
            ...
            delete.addActionListener(del -> {
                if (Dialog.show("Confirmation", "Delete \" " + e.getNom() + "\" ?", "ok", "cancel")) {
                    ...
                    if (ServiceEvent.getInstance().deleteEvent(e)) {
            ...
            dlg.add(new SpanLabel("Nom : " + e.getNom() + "\ntype : " + e.getType()+ "\ndescription: " + e.getDescription(), "DialogBody"));
